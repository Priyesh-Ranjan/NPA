...
def main(args):
    ...
    if args.dataset == 'mnist':
        ...
        from tasks import DDSM
        trainData = DDSM.train_dataloader(args.num_clients, loader_type=args.loader_type, path=args.loader_path,
                                          store=False)
        testData = DDSM.test_dataloader(args.test_batch_size)
        Net = DDSM.Net
